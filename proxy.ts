...
const ALWAYS_PUBLIC_PREFIXES = [
  ...
  // รูปเมนู/โลโก้ที่ร้านอัปโหลด (Phase 17a) — หน้าเมนูฝั่งลูกค้าไม่มี session ถ้าโดนเด้งไป /login
  // รูปทั้งหน้าจะกลายเป็นกรอบว่าง · ตัวระบุคือ id ของรูปเท่านั้น ไม่มีข้อมูลร้านให้รั่ว
  "/api/assets",
