...
ทดสอบสแกน QR ด้วยมือถือจริง (Phase 9) · **Phase 18 เว็บสาธารณะค้นหาร้าน (`/explore` + Longdo Map + รีวิว) — วางแผนไว้ใน spec §8 แล้ว 2026-09-18 รวมในโปรเจกต์นี้เป็น route group `(public)` · ยังไม่เริ่มจนกว่าเจ้าของสั่ง** — Phase 5 ปิดครบแล้ว 2026-09-17 (สมัครด้วยอีเมลจริงผ่าน: อีเมลเข้ากล่องหลัก · ยืนยันแล้วล็อกอินได้) —
